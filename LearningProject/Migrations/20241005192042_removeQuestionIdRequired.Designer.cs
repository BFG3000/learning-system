...
namespace LearningProject.Migrations
{
    ...
    [Migration("20241005192042_removeQuestionIdRequired")]
    partial class removeQuestionIdRequired
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LearningProject.Models.InternalUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 5, 22, 20, 41, 921, DateTimeKind.Local).AddTicks(8391),
                            InternalUserId = 1,
                            RoleId = 1
                        });
                });
